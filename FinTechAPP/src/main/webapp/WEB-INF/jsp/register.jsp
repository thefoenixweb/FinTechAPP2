        ...
        <div class="card-body">
            ...
            <form:form action="/register" class="reg-form" modelAttribute="registerUser">
                ...
                <div class="row">
                 ...
                 <!-- From Group -->
                    <div class="form-group col">
                        <form:input type="integer" path="address" class="form-control form-control-lg" placeholder="Enter Address"/>
                        <form:errors path="address" class="text-white bg-danger"/>
                    </div>
                    <!-- End Of From Group -->
                </div>
                ...
                <div class="row">
                 ...
                 <!-- From Group -->
                    <div class="form-group col">
                        <form:input type="text" path="contact" class="form-control form-control-lg" placeholder="Enter contact number"/>
                        <form:errors path="contact" class="text-white bg-danger"/>
                    </div>
                    <!-- End Of From Group -->
                
                <!-- From Group -->
                    <div class="form-group col">
                        <form:input type="text" path="age" class="form-control form-control-lg" placeholder="Enter age"/>
                        <form:errors path="age" class="text-white bg-danger"/>
                    </div>
                    <!-- End Of From Group -->
                ...
                <!-- From Group -->
                <div class="form-group col">
                    <form:input type="text" path="user1" class="form-control form-control-lg" placeholder="Enter User Name"/>
                    <form:errors path="user1" class="text-white bg-danger"/>
