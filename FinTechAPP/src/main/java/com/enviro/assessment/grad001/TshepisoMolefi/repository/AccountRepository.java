...
public interface AccountRepository extends CrudRepository<Account, Integer> {
    ...
    @Query(value = "SELECT account_type FROM accounts WHERE user_id = :user_id AND account_id = :account_id", nativeQuery =true)
    String getAccountType(@Param("user_id") int user_id, @Param("account_id") int account_id);
